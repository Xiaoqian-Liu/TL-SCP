...
# define outputs
Err_Lasso <- matrix(NA, nrow = nP, ncol = nReps)
Err_SCAD <- matrix(NA, nrow = nP, ncol = nReps)
Err_MCP <- matrix(NA, nrow = nP, ncol = nReps)
Err_Dist <- matrix(NA, nrow = nP, ncol = nReps)
Err_cox <- matrix(NA, nrow = nP, ncol = nReps)



# AMI
AMI_Lasso <- matrix(NA, nrow = nP, ncol = nReps)
AMI_SCAD <- matrix(NA, nrow = nP, ncol = nReps)
AMI_MCP <- matrix(NA, nrow = nP, ncol = nReps)
AMI_Dist <- matrix(NA, nrow = nP, ncol = nReps)
AMI_cox <- matrix(NA, nrow = nP, ncol = nReps)


# max variant of NMI
NMI_M_Lasso <- matrix(NA, nrow = nP, ncol = nReps)
NMI_M_SCAD <- matrix(NA, nrow = nP, ncol = nReps)
NMI_M_MCP <- matrix(NA, nrow = nP, ncol = nReps)
NMI_M_Dist <- matrix(NA, nrow = nP, ncol = nReps)
NMI_M_cox <- matrix(NA, nrow = nP, ncol = nReps)
...
k_Dist <- matrix(NA, nrow = nP, ncol = nReps)

# record running time 
time_Lasso <- matrix(NA, nrow = nP, ncol = nReps)
time_SCAD <- matrix(NA, nrow = nP, ncol = nReps)
time_MCP <- matrix(NA, nrow = nP, ncol = nReps)
time_Dist <- matrix(NA, nrow = nP, ncol = nReps)
time_cox <- matrix(NA, nrow = nP, ncol = nReps)
